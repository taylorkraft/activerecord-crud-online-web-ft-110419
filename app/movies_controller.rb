...
def can_be_created_in_a_block(hash = {title: "Home Alone", release_date: ""})
...
def can_destroy_a_single_item
  ...
  destroyed_movie = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once").destroy
end
